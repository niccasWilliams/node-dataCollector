...
CREATE TABLE "product_prices" (
	...
	"is_price_error" boolean DEFAULT false NOT NULL,
	"confidence" numeric(3, 2) DEFAULT '1.00' NOT NULL,
	"metadata" jsonb DEFAULT '{}'::jsonb,
	"scraped_at" timestamp DEFAULT CURRENT_TIMESTAMP NOT NULL,
	"created_at" timestamp DEFAULT CURRENT_TIMESTAMP NOT NULL,
	CONSTRAINT "product_price_variant_source_unique" UNIQUE("variant_id","product_source_id")
);
--> statement-breakpoint
...
CREATE INDEX "product_price_variant_idx" ON "product_prices" USING btree ("variant_id");--> statement-breakpoint
CREATE INDEX "product_price_source_idx" ON "product_prices" USING btree ("product_source_id");--> statement-breakpoint
CREATE INDEX "product_price_price_idx" ON "product_prices" USING btree ("price");--> statement-breakpoint
CREATE INDEX "product_price_availability_idx" ON "product_prices" USING btree ("availability");--> statement-breakpoint
CREATE INDEX "product_price_error_idx" ON "product_prices" USING btree ("is_price_error");--> statement-breakpoint
CREATE INDEX "product_price_scraped_idx" ON "product_prices" USING btree ("scraped_at");--> statement-breakpoint
